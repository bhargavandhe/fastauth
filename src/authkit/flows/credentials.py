...
from authkit.domain.enums import HookPhase, ProviderId
...
from authkit.domain.models import Account, Session, User, WireModel
...
async def record_failure_and_maybe_emit(
    ...
    """
    from authkit.exceptions import AccountLockedError
