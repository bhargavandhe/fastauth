...
file) mirrors the split between :mod:`authkit.flows.credentials` and the
route handlers in :mod:`authkit.web.fastapi`.
...
async def request_email_change_otp(
    ...
    *,
    ...
    token-based change-email flow (:mod:`authkit.flows.change_email`).
    """
