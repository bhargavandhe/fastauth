...
from authkit.domain.enums import AuditEventType
from authkit.domain.events import AuthEvent
from authkit.domain.models import AuditLog, WireModel
from authkit.exceptions import ConfigError, CsrfError, InvalidCredentialsError
...
class AuditLogsPlugin(Plugin):
    ...
    id: ClassVar[str] = "authkit-audit-logs"
    ...
    async def current_user_id(self, request: Request) -> str:
        ...
        ``authkit.web.fastapi`` and ``authkit.plugins.audit_logs``.
        """
