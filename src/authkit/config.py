"""Pydantic configuration for authkit.

:class:`AuthKitConfig` is a plain Pydantic v2 ``BaseModel``. All values are
...
the values in as constructor arguments and authkit will validate them.
"""
